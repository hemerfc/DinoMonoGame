...
namespace DinoGame
{
    ...
    public class InputState
    {
        ...
        public bool IsLeft(PlayerIndex? controllingPlayer)
        {
            ...
            return IsKeyPressed(Keys.Left, controllingPlayer, out playerIndex) || IsButtonPressed(Buttons.DPadLeft, controllingPlayer, out playerIndex)
        ...
        public bool IsRight(PlayerIndex? controllingPlayer)
        {
            ...
            return IsKeyPressed(Keys.Right, controllingPlayer, out playerIndex) || IsButtonPressed(Buttons.DPadRight, controllingPlayer, out playerIndex)
        ...
        public bool IsUp(PlayerIndex? controllingPlayer)
        {
            ...
            return IsKeyPressed(Keys.Up, controllingPlayer, out playerIndex) || IsButtonPressed(Buttons.DPadUp, controllingPlayer, out playerIndex)
        ...
        public bool IsDown(PlayerIndex? controllingPlayer)
        {
            ...
            return IsKeyPressed(Keys.Down, controllingPlayer, out playerIndex) || IsButtonPressed(Buttons.DPadDown, controllingPlayer, out playerIndex)
        ...
        public bool HasResetCommand(PlayerIndex? controllingPlayer)
        {
            PlayerIndex playerIndex;
        ...
        public bool HasDebugCommand(PlayerIndex? controllingPlayer)
        {
            PlayerIndex playerIndex;

            // ctrl + D
            return IsKeyPressed(Keys.LeftControl, controllingPlayer, out playerIndex)  &&
